...
/**
 * shadcn/sonner wrapper with a 2s dedupe by exact title, so a burst of identical "Nothing under
 * the burette" toasts collapses into one. Registered with `setToastSink` from `@/lib/events`
