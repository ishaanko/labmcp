...
/**
 * Short dock-tile text. A tile is 64px wide, so the shelf's full names ("Sodium hydroxide",
...
const INDICATOR_SHORT: Readonly<Record<string, string>> = { phenolphthalein: "Phenol", universal: "Universal", litmus: "Litmus" };
